...
You'll get a URL like `https://your-unique-id.ngrok.io` (where `your-unique-id` is randomly generated by ngrok). Use this as your webhook URL:
```
https://your-unique-id.ngrok.io/api/webhooks/paystack
```
